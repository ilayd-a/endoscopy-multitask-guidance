"""
train_segformer.py
SegFormer trained on CVC-ClinicDB.

Usage:
    PYTHONPATH=. python models/train_segformer.py
"""
...
for epoch in range(num_epochs):
    ...
    if val_dice > best_val_dice:
        ...
        save_path = MODELS_DIR / "segformer_cvc.pth"
...
print("  Architecture : SegFormer with MiT-B0 encoder pretrained on ImageNet")
...
plt.grid(True)
plt.tight_layout()
loss_plot_path = MODELS_DIR / "segformer_cvc_loss_curve.png"
...
plt.grid(True)
plt.tight_layout()
dice_plot_path = MODELS_DIR / "segformer_cvc_dice_curve.png"
